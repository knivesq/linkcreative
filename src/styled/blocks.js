...
import {
    ...
    Container,
    Hexagon,
    StyledAnchor, Input, Label, SpanStyled
} from "./elements";
...
export const Block = styled.div`
    ...
    font-family: ${props => props.fontFamily ? props.fontFamily : SegoeWPN} !important;
...
export const DryInput = Input;
export const DryLabel = Label;
export const DrySpan = SpanStyled;
